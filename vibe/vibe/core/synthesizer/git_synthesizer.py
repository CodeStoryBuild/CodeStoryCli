...
## Imports
from ..data.models import CommitGroup, Addition, Removal, CommitResult, ChunkApplicationData
...
class GitSynthesizer:
    ...
    def _apply_chunks_to_lines(self, original_lines: List[str], chunks_data: List[ChunkApplicationData]) -> str:
        """
    ...
    def _build_tree_from_plan(self, base_tree_hash: str, cumulative_chunks: List[Union[StandardDiffChunk, RenameDiffChunk]]) -> str:
        ...
        for chunk in cumulative_chunks:
            if isinstance(chunk, RenameDiffChunk):
                ...
                new_content = self._apply_chunks_to_lines(original_lines, chunk.application_data)
        ...
        for file_path, chunks in chunks_by_file.items():
            ...
            for chunk in chunks:
                ...
                if removals and additions:
                    chunks_data.append(ChunkApplicationData(
