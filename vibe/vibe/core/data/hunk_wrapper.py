...
class HunkWrapper:
    ...
    def create_empty_content(
        new_file_path: str, old_file_path: str, file_mode: Optional[str] = None
    ) -> "HunkWrapper":
        return HunkWrapper(
    ...
    def create_empty_addition(
        new_file_path: str, file_mode: Optional[str] = None
    ) -> "HunkWrapper":
        return HunkWrapper(
            new_file_path=new_file_path,
            old_file_path=None,
    ...
    def create_empty_deletion(
        old_file_path: str, file_mode: Optional[str] = None
    ) -> "HunkWrapper":
        return HunkWrapper(
            new_file_path=None,
            old_file_path=old_file_path,
