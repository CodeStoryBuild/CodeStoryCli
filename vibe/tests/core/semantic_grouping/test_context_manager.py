...
from vibe.semantic_grouping.semantic_grouper.context_manager import ContextManager
...
def test_context_manager():
    ...
    if new_file_context:
        print(f"✓ New file new_file.py: {new_file_context.parsed_file.detected_language}")
    else:
