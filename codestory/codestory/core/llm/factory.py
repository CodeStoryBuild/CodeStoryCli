...
class CodeStoryAdapter:
    ...
    def invoke(self, messages: Union[str, List[Dict[str, str]]]) -> str:
        ...
        try:
            ...
            raise ConfigurationError(f"{self.provider} API failed: {e.response.text}") from e
    ...
    def _call_gemini(self, messages: List[Dict[str, str]]) -> str:
        ...
        try:
            ...
            raise ConfigurationError("Gemini refused to generate content (likely safety filter).")
