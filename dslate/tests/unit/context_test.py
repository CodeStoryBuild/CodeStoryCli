...
from dslate.context import GlobalConfig, GlobalContext, CommitContext, FixContext, CleanContext
...
def test_global_context_from_config_defaults(mock_git_commands, mock_git_interface, mock_create_model):
...
@patch("dslate.context.SubprocessGitInterface")
@patch("dslate.context.GitCommands")
def test_global_context_from_config_custom(mock_git_commands, mock_git_interface, mock_create_model):
